...
interface GenericDataInfo {
  cid: string;
  title: string;
  is_encrypted: boolean; // Use snake_case to match the database response
  lit_token_id?: string;
  year?: string;
  authors?: string[];
  doi?: string;
...
const DataIngestionPage: React.FC = () => {
  ...
  const handleUnencryptedUpload = async () => {
    ...
    formData.append('isEncrypted', 'false'); // Explicitly send flag
    ...
    <>
      <div className="max-w-6xl mx-auto p-4 md:p-8">
        ...
        <div className="mt-10 gap-8">
          <div>
            <div className="flex justify-between items-center mb-4"><h2 className="text-xl font-semibold">{historyTitle}</h2></div>
